...
const navItems = [
  ...
  { to: '/events', label: 'Event Log', icon: 'Events' },
      ...
      <div className="px-5 py-4 border-t border-border mt-auto">
        <div className="flex items-center gap-3 py-1">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-xs font-semibold text-ink">Convex Connected</p>
            <p className="text-[11px] text-ink-muted">Demo mode — local storage</p>
          </div>
        </div>
      </div>
    </aside>
